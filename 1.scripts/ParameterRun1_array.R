...
s.max1_vector=parameter_table[rows,1]
s.max2_vector=parameter_table[rows,2]
period1_vector=parameter_table[rows,3]
period2_vector=parameter_table[rows,4]
phase.shift2_vector=parameter_table[rows,5]
r_vector=parameter_table[rows,6]
random_vector=parameter_table[rows,7]
