...
##### parameters. We did the above in    #####
##### making the file, we now simply     #####
##### take a subset of the file.         #####
##############################################
...
s.max1_vector=rep(parameter_table[rows,1], 500)
s.max2_vector=rep(parameter_table[rows,2], 500)
period1_vector=rep(parameter_table[rows,3], 500)
period2_vector=rep(parameter_table[rows,4], 500)
phase.shift2_vector=rep(parameter_table[rows,5], 500)
r_vector=rep(parameter_table[rows,6], 500)
random_vector=rep(parameter_table[rows,7], 500)
...
outfile<-paste("2.math_model_results/1.parameter_run_2_random/ParameterRun1_Output_", start, "-", end, ".txt", sep = '')
